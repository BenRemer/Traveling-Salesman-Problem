...
Files submitted:
        Genetic.py → the main file that contains not only the main method (find_tsp) but also all of the methods for the genetic algorithm. This is the most important file in the project submission
        ...
        out.txt --> the output file from the 30 node test case
